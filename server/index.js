...
app.get('/products/styles', (req, res) => {
  axios.get('https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfe/products/37311/styles', { headers: {'Authorization': `${config.TOKEN}` } })
    .then(data => {
      res.send(data.data);
    })
    .catch(err => {
...
app.get('/products', (req, res) => {
  axios.get('https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfe/products/37311', { headers: {'Authorization': `${config.TOKEN}` } })
    .then(data => {
      res.send(data.data);
    })
    .catch(err => {
...
app.get('/products/reviews', (req, res) => {
  axios.get('https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfe/reviews/meta', { params: {product_id: '37311' }, headers: {'Authorization': `${config.TOKEN}` } })
    .then(data => {
...
app.get('/products/review', (req, res) => {
  axios.get('https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfe/reviews/', { params: {product_id: '37311', count: 1000 }, headers: {'Authorization': `${config.TOKEN}` } })
    .then(data => {
